...
<div class="svc-grid">
<div class="svc-c a up d1"><div class="svc-num">01</div><svg aria-hidden="true" class="card-icon"><use href="#ic-ecg"></use></svg><svg aria-hidden="true" class="card-wm"><use href="#ic-ecg"></use></svg><h3 class="svc-h">Coronary Angiography</h3><p class="svc-p">Catheter-based imaging to precisely map the coronary arteries, identify blockages, and guide optimal treatment planning. The gold standard for coronary artery disease diagnosis. Dr Khatri's expertise in this procedure has made him a leading cardiologist on the Gold Coast.</p></div>
<div class="svc-c a up d2"><div class="svc-num">02</div><svg aria-hidden="true" class="card-icon"><use href="#ic-vessel"></use></svg><svg aria-hidden="true" class="card-wm"><use href="#ic-vessel"></use></svg><h3 class="svc-h">Angioplasty &amp; Stenting</h3><p class="svc-p">Minimally invasive restoration of coronary blood flow using balloon angioplasty and drug-eluting stents — achieving open-artery results without open-heart surgery. As a specialist interventional cardiologist, Dr Khatri has perfected this life-saving technique.</p></div>
<div class="svc-c a up d3"><div class="svc-num">03</div><svg aria-hidden="true" class="card-icon"><use href="#ic-pci"></use></svg><svg aria-hidden="true" class="card-wm"><use href="#ic-pci"></use></svg><h3 class="svc-h">Primary PCI — Heart Attack</h3><p class="svc-p">Emergency heart attack treatment via angioplasty for acute myocardial infarction — available 24 hours a day, 7 days a week. Rapid restoration of blood flow to limit heart muscle damage. Dr Khatri's emergency cardiology service has saved countless lives. <span class="svc-badge">1,500+ · 24/7</span></p></div>
