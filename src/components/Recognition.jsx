...
const markup = `
<!-- ═══ RECOGNITION ════════════════════════════════════════════ -->
<section class="sec bg2" id="recognition">
<div class="wrap">
<div class="rec-grid">
...
<div class="rec-c"><svg aria-hidden="true" class="rec-icon"><use href="#ic-shield"></use></svg><div><h3 class="rc-h">Pioneer — Tweed Hospital Primary PCI</h3><p class="rc-p">Established the emergency cardiac service at Tweed Hospital over 20 years ago, extending life-saving care to uninsured patients from the NSW Northern Rivers region.</p></div></div>
<div class="fellowship"><div class="fl-pre">International Fellowship · Vancouver, Canada · 2001</div><h3 class="fl-h">St. Paul's Hospital — Under Professor John Webb</h3><p class="fl-p">Trained under one of the world's most celebrated interventional cardiologists, completing over 1,200 procedures. This international pedigree is the foundation of a world-class Gold Coast practice.</p></div>
</div>
<div class="rec-info a rgt">
<div class="rec-info-text">
<h2 class="sec-title">Recognised by Peers &amp; <em>The Community</em></h2>
