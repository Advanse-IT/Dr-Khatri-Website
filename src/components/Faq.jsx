...
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Do I need a referral to see Dr Khatri?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">Yes — a GP referral is required for all consultations. Your GP will assess your symptoms, arrange initial tests, and write a referral to Dr Shailesh Khatri. Contact the rooms on (07) 5598 0322 with your referral to schedule a consultation at either <strong>John Flynn Private Hospital</strong> (Tugun) or <strong>Pindara Private Hospital</strong> (Benowa). Dr Khatri provides consultations and admitting rights at both locations.</div></div></div>
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Where does Dr Khatri consult?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">Dr Khatri provides consultations and holds admitting rights at both <strong>John Flynn Private Hospital</strong> (Tugun, QLD 4224) and <strong>Pindara Private Hospital</strong> (Benowa, QLD 4217). His consulting rooms are located at John Flynn Specialist Suites, Level 3, Suites 301–303, 42 Inland Drive, Tugun. This dual-hospital arrangement allows patients across the Gold Coast to be treated at the hospital most convenient to them.</div></div></div>
