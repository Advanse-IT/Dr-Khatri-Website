...
<div class="jstep-arr" aria-hidden="true">→</div>
</div>
<div class="jstep a up d2">
<div class="jstep-n" aria-hidden="true">2</div>
...
<div class="jstep-n" aria-hidden="true">3</div>
...
<div class="a up d4" style="margin-top:18px;background:rgba(var(--ar),.06);border:1px solid rgba(var(--ar),.18);border-radius:7px;padding:14px 18px;display:flex;align-items:flex-start;gap:12px;max-width:680px;margin-left:auto;margin-right:auto" role="note" aria-label="Cardiac emergency information">
