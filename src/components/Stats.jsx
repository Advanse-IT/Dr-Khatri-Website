...
<img src="/images/anatomical-heart.svg" class="stats-heart" style="position:absolute;width:450px;right:-100px;bottom:-50px;opacity:0.18;filter:brightness(0) invert(1) sepia(1) saturate(1.5) hue-rotate(330deg);pointer-events:none" alt="" />
