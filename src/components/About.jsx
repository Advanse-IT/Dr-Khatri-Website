...
import { isRelocated, NEW_LOCATION } from '../config/relocation.js';

const relocated = isRelocated();
const consultingSentence = relocated
  ? `He consults from ${NEW_LOCATION.name}, and holds admitting rights at both John Flynn Private Hospital (Tugun) and Pindara Private Hospital (Benowa) for inpatient care and procedures, allowing patients to be treated at the hospital most convenient to them.`
  : `He provides consultations and holds admitting rights at both John Flynn Private Hospital (Tugun) and Pindara Private Hospital (Benowa), allowing patients to be treated at the hospital most convenient to them.`;
...
<p class="sec-lead">Dr Khatri is dedicated to delivering high-quality, patient-centred care, and has provided a 24-hour cardiology service to the Gold Coast for over two decades. ${consultingSentence} Recognising that cardiac emergencies can occur at any time, he prioritises care and timely access to treatment 24 hours a day, 7 days a week.</p>
