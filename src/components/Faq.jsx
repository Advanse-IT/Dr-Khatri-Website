...
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Do I need a referral to see Dr Khatri?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">Yes — a GP referral is required for all consultations. Your GP will assess your symptoms, arrange initial tests, and write a referral to Dr Shailesh Khatri. Contact the rooms on (07) 5598 0322 with your referral to schedule an appointment at either John Flynn Specialist Suites (Tugun) or Pindara Private Hospital (Benowa).</div></div></div>
