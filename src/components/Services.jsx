...
<div class="svc-grid">
<div class="svc-c a up d1"><div class="svc-num">01</div><svg aria-hidden="true" class="card-icon"><use href="#ic-ecg"></use></svg><svg aria-hidden="true" class="card-wm"><use href="#ic-ecg"></use></svg><h3 class="svc-h">Coronary Angiography</h3><p class="svc-p">Catheter-based imaging to precisely map the coronary arteries, identify blockages, and guide optimal treatment planning. The gold standard for coronary artery disease diagnosis.</p></div>
...
<div class="svc-c a up d3"><div class="svc-num">03</div><svg aria-hidden="true" class="card-icon"><use href="#ic-pci"></use></svg><svg aria-hidden="true" class="card-wm"><use href="#ic-pci"></use></svg><h3 class="svc-h">Primary PCI — Heart Attack</h3><p class="svc-p">Emergency angioplasty for acute myocardial infarction — available 24 hours a day, 7 days a week. Rapid restoration of blood flow to limit heart muscle damage. <span class="svc-badge">1,500+ · 24/7</span></p></div>
