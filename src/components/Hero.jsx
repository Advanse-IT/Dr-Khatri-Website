...
<img src="/images/anatomical-heart.svg" class="heart-bg" style="width:340px;right:-10px;bottom:60px;position:absolute;opacity:0.15;filter:sepia(1) saturate(2) hue-rotate(10deg);pointer-events:none" alt="" />
<div class="hero-in">
<div>
