...
const referralAnswer = relocated
  ? `Yes — a GP referral is required for all consultations. Your GP will assess your symptoms, arrange initial tests, and write a referral to Dr Shailesh Khatri. Contact the rooms on ${phone.display} with your referral to schedule a consultation at ${NEW_LOCATION.name}. For inpatient care and procedures, Dr Khatri holds admitting rights at <strong>John Flynn Private Hospital</strong> (Tugun) and <strong>Pindara Private Hospital</strong> (Benowa).`
  : `Yes — a GP referral is required for all consultations. Your GP will assess your symptoms, arrange initial tests, and write a referral to Dr Shailesh Khatri. Contact the rooms on ${phone.display} with your referral to schedule a consultation at either <strong>John Flynn Private Hospital</strong> (Tugun) or <strong>Pindara Private Hospital</strong> (Benowa). Dr Khatri provides consultations and admitting rights at both locations.`;

const whereConsultAnswer = relocated
  ? `Dr Khatri consults from ${NEW_LOCATION.name}, ${NEW_LOCATION.addressLine}. For inpatient care and procedures, he holds admitting rights at both <strong>John Flynn Private Hospital</strong> (Tugun, QLD 4224) and <strong>Pindara Private Hospital</strong> (Benowa, QLD 4217), allowing patients to be treated at the hospital most convenient to them for hospital-based care.`
  : `Dr Khatri provides consultations and holds admitting rights at both <strong>John Flynn Private Hospital</strong> (Tugun, QLD 4224) and <strong>Pindara Private Hospital</strong> (Benowa, QLD 4217). His consulting rooms are located at John Flynn Specialist Suites, Level 3, Suites 301–303, 42 Inland Drive, Tugun. This dual-hospital arrangement allows patients across the Gold Coast to be treated at the hospital most convenient to them.`;
...
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Do I need a referral to see Dr Khatri?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">${referralAnswer}</div></div></div>
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Where does Dr Khatri consult?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">${whereConsultAnswer}</div></div></div>
...
<div class="faq-item"><button class="faq-q" onclick="faq(this)" aria-expanded="false">Is emergency cardiac care available after hours?<span class="faq-arr">▼</span></button><div class="faq-body"><div class="faq-body-in">Yes. Dr Khatri provides 24-hour emergency cardiology care and holds admitting rights at both <strong>John Flynn Private Hospital</strong> (Tugun) and <strong>Pindara Private Hospital</strong> (Benowa). He has provided this life-saving service to the Gold Coast for over two decades. Recognising that cardiac emergencies can occur at any time, he prioritises rapid care and timely access to treatment. He has personally performed over 1,500 Primary PCI procedures for patients experiencing acute heart attacks. In a life-threatening emergency, always call 000 first.</div></div></div>
